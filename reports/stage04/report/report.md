...
Добавляем информацию о навыках (рис. [-@fig:001])
...
Добавляем информацию о достижениях (рис. [-@fig:003]), (рис. [-@fig:004])
 
![Информация о достижениях](image/3.png){#fig:003 width=70%}

Деляем пост по прошедшей неделе и добавляем пост на тему язык разметки Markdown (рис. [-@fig:005])
 
![Посты](image/4.png){#fig:005 width=70%}
